// Table preview component - scrollable data grid for quick verification before export
    ...
    <div className="h-full w-full overflow-auto rounded-md border border-gray-200 bg-gray-50">
      ...
      {rows.length > maxRows && (
        <div className="border-t border-gray-200 bg-white px-3 py-2 text-xs text-gray-600">
          Showing first {maxRows} rows for preview. Download JSON to export the full dataset.
        </div>
      )}
    </div>
  )
